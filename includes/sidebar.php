...
<<<<<<< HEAD
            ...
            <a href="<?php echo BASE_URL; ?>/admin/dashboard.php"
                class="sidebar-link <?php echo isActivePage('dashboard.php'); ?>">
            ...
            <a href="<?php echo BASE_URL; ?>/admin/programs.php"
                class="sidebar-link <?php echo isActivePage('programs.php'); ?>">
        ...
        elseif ($userRole === 'nurse'): ?>
            ...
            <div class="sidebar-section-title">Main</div>
            <a href="<?php echo BASE_URL; ?>/nurse/dashboard.php"
                class="sidebar-link <?php echo isActivePage('dashboard.php'); ?>">
                <i class="bi bi-speedometer2"></i><span>Dashboard</span>
            </a>
            ...
            <a href="<?php echo BASE_URL; ?>/nurse/content.php?tab=announcements"
                class="sidebar-link <?php echo isActivePage('content.php'); ?>">
        ...
        elseif ($userRole === 'rep'): ?>
            ...
            <div class="sidebar-section-title">Main</div>
            <a href="<?php echo BASE_URL; ?>/rep/dashboard.php"
                class="sidebar-link <?php echo isActivePage('dashboard.php'); ?>">
                <i class="bi bi-speedometer2"></i><span>Dashboard</span>
            </a>

            <div class="sidebar-section-title">Students</div>
            <a href="<?php echo BASE_URL; ?>/rep/students.php"
                class="sidebar-link <?php echo isActivePage('students.php'); ?>">
