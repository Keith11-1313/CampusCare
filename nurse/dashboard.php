...
<div class="row g-4 mb-4">
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php if (empty($upcomingFollowUps)): ?>
                    <div class="empty-state py-3"><i class="bi bi-calendar-check"></i><p class="small">No upcoming follow-ups.</p></div>
                <?php else:
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2 pb-2 border-bottom">
                    <div>
                        <div class="fw-semibold small"><?php echo e($fv['first_name'] . ' ' . $fv['last_name']); ?></div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <a href="<?php echo BASE_URL; ?>/nurse/new_visit.php" class="btn btn-outline-primary btn-sm w-100 mb-2 text-start">
                    <i class="bi bi-plus-circle me-2"></i>Record New Visit</a>
                <a href="<?php echo BASE_URL; ?>/nurse/students.php" class="btn btn-outline-primary btn-sm w-100 mb-2 text-start">
                    <i class="bi bi-search me-2"></i>Search Students</a>
                <a href="<?php echo BASE_URL; ?>/nurse/visits.php" class="btn btn-outline-primary btn-sm w-100 mb-2 text-start">
                    <i class="bi bi-clipboard2-pulse me-2"></i>Visit History</a>
                <a href="<?php echo BASE_URL; ?>/nurse/reports.php" class="btn btn-outline-primary btn-sm w-100 text-start">
